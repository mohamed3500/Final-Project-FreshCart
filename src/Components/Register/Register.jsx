...
export default function Register() {
  ...
  return (
    <>
      <h2 className="text-xl text-center my-8">Register Now</h2>
      <form className="w-1/2 mx-auto" onSubmit={formik.handleSubmit}>
        ...
        <button
          type="submit"
          className={`text-white mt-3 bg-emerald-400 hover:bg-emerald-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800`}
          disabled={isLoading}
        >
